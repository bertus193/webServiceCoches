                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":AsignarVehiculos",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "AsignarVehiculos",
    ...
    public static class Factory{
        ...
        */
        public static AsignarVehiculos parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            AsignarVehiculos object =
                new AsignarVehiculos();
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"AsignarVehiculos".equals(type)){
                                ...
                                return (AsignarVehiculos)org.example.www.alquilervehiculos.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
