...
public class GenerarPresupuesto implements org.apache.axis2.databinding.ADBBean {

	public static final javax.xml.namespace.QName MY_QNAME = new javax.xml.namespace.QName(
			"http://www.example.org/AlquilerVehiculos/", "GenerarPresupuesto", "ns1");
		...
		if (serializeType) {
			...
			if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)) {
				writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type",
						namespacePrefix + ":GenerarPresupuesto", xmlWriter);
			} else {
				writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type", "GenerarPresupuesto",
						xmlWriter);
			}
	...
	public static class Factory {
		...
		public static GenerarPresupuesto parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
			GenerarPresupuesto object = new GenerarPresupuesto();
				...
				if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance", "type") != null) {
					...
					if (fullTypeName != null) {
						...
						if (!"GenerarPresupuesto".equals(type)) {
							...
							return (GenerarPresupuesto) org.example.www.alquilervehiculos.ExtensionMapper
