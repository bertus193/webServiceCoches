...
public class AlquilerVehiculosMessageReceiverInOut extends org.apache.axis2.receivers.AbstractInOutMessageReceiver {
	...
	//
	private org.apache.axiom.om.OMElement toOM(org.example.www.alquilervehiculos.AsignarVehiculos param,
			boolean optimizeContent) throws org.apache.axis2.AxisFault {

		try {
			return param.getOMElement(org.example.www.alquilervehiculos.AsignarVehiculos.MY_QNAME,
	...
	private org.apache.axiom.om.OMElement toOM(org.example.www.alquilervehiculos.AsignarVehiculosResponse param,
			boolean optimizeContent) throws org.apache.axis2.AxisFault {
	...
	private org.apache.axiom.om.OMElement toOM(org.example.www.alquilervehiculos.ObtenerVehiculos param,
			boolean optimizeContent) throws org.apache.axis2.AxisFault {
	...
	private org.apache.axiom.om.OMElement toOM(org.example.www.alquilervehiculos.ObtenerVehiculosResponse param,
			boolean optimizeContent) throws org.apache.axis2.AxisFault {
	...
	private org.apache.axiom.soap.SOAPEnvelope toEnvelope(org.apache.axiom.soap.SOAPFactory factory,
			org.example.www.alquilervehiculos.AsignarVehiculosResponse param, boolean optimizeContent,
			javax.xml.namespace.QName methodQName) throws org.apache.axis2.AxisFault {
		try {
			org.apache.axiom.soap.SOAPEnvelope emptyEnvelope = factory.getDefaultEnvelope();

			emptyEnvelope.getBody().addChild(
					param.getOMElement(org.example.www.alquilervehiculos.AsignarVehiculosResponse.MY_QNAME, factory));
	...
	private org.example.www.alquilervehiculos.AsignarVehiculosResponse wrapAsignarVehiculos() {
		org.example.www.alquilervehiculos.AsignarVehiculosResponse wrappedElement = new org.example.www.alquilervehiculos.AsignarVehiculosResponse();
	...
	private org.apache.axiom.soap.SOAPEnvelope toEnvelope(org.apache.axiom.soap.SOAPFactory factory,
		...
		try {
			...
			emptyEnvelope.getBody().addChild(
					param.getOMElement(org.example.www.alquilervehiculos.ObtenerVehiculosResponse.MY_QNAME, factory));
	...
	private java.lang.Object fromOM(org.apache.axiom.om.OMElement param, java.lang.Class type,
		...
		try {
			...
			if (org.example.www.alquilervehiculos.AsignarVehiculos.class.equals(type)) {

				return org.example.www.alquilervehiculos.AsignarVehiculos.Factory
			...
			if (org.example.www.alquilervehiculos.ObtenerVehiculos.class.equals(type)) {
				...
				return org.example.www.alquilervehiculos.ObtenerVehiculos.Factory
						.parse(param.getXMLStreamReaderWithoutCaching());
			...
			if (org.example.www.alquilervehiculos.ObtenerVehiculosResponse.class.equals(type)) {
				...
				return org.example.www.alquilervehiculos.ObtenerVehiculosResponse.Factory
						.parse(param.getXMLStreamReaderWithoutCaching());
