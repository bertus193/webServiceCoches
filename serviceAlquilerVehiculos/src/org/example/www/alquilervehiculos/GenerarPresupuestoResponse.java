...
public class GenerarPresupuestoResponse implements org.apache.axis2.databinding.ADBBean {

	public static final javax.xml.namespace.QName MY_QNAME = new javax.xml.namespace.QName(
			"http://www.example.org/AlquilerVehiculos/", "GenerarPresupuestoResponse", "ns1");
		...
		if (serializeType) {
			...
			if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)) {
				writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type",
						namespacePrefix + ":GenerarPresupuestoResponse", xmlWriter);
			} else {
				writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type", "GenerarPresupuestoResponse",
						xmlWriter);
			}
	...
	public static class Factory {
		 ...
		 * outer element
		 */
		public static GenerarPresupuestoResponse parse(javax.xml.stream.XMLStreamReader reader)
				throws java.lang.Exception {
			GenerarPresupuestoResponse object = new GenerarPresupuestoResponse();
				...
				if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance", "type") != null) {
					...
					if (fullTypeName != null) {
						...
						if (!"GenerarPresupuestoResponse".equals(type)) {
							...
							return (GenerarPresupuestoResponse) org.example.www.alquilervehiculos.ExtensionMapper
