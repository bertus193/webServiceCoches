...
/**
 * AsignarVehiculosResponse bean class
 */
@SuppressWarnings({ "unchecked", "unused" })

public class AsignarVehiculosResponse implements org.apache.axis2.databinding.ADBBean {
		...
		if (serializeType) {
			...
			if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)) {
				writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type",
						namespacePrefix + ":AsignarVehiculosResponse", xmlWriter);
			} else {
				writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type", "AsignarVehiculosResponse",
						xmlWriter);
			}
	...
	public static class Factory {
		 ...
		 * outer element
		 */
		public static AsignarVehiculosResponse parse(javax.xml.stream.XMLStreamReader reader)
				throws java.lang.Exception {
			AsignarVehiculosResponse object = new AsignarVehiculosResponse();
			...
			try {
				...
				if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance", "type") != null) {
					...
					if (fullTypeName != null) {
						...
						if (!"AsignarVehiculosResponse".equals(type)) {
							// find namespace for the prefix
							java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
							return (AsignarVehiculosResponse) org.example.www.alquilervehiculos.ExtensionMapper
