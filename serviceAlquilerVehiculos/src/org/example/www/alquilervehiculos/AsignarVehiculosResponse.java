 ...
 */
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":AsignarVehiculosResponse",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "AsignarVehiculosResponse",
    ...
    public static class Factory{
        ...
        */
        public static AsignarVehiculosResponse parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            AsignarVehiculosResponse object =
                new AsignarVehiculosResponse();
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"AsignarVehiculosResponse".equals(type)){
                                ...
                                return (AsignarVehiculosResponse)org.example.www.alquilervehiculos.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
